...
# 1. Baixar HTML original
response = requests.get(URL)
response.encoding = "latin-1"  # encoding usado no site do Planalto
html = response.text

# 2. Parser com BeautifulSoup
soup = BeautifulSoup(html, "html.parser")

# 3. Novo HTML (estrutura semântica)
novo_html = [
    "<!DOCTYPE html>",
    "<html lang='pt-BR'>",
    "<head>",
...
# 6. Salvar resultado
with open("lei_13709_estruturada.html", "w", encoding="utf-8") as f:
    f.write("\n".join(novo_html))

print("✅ Lei estruturada salva em lei_13709_estruturada.html")
